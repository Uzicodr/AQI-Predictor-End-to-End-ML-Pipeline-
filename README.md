...
- XGBoost, Random Forest, Ridge Regression are compared for 72-hour-ahead AQI prediction, then the model with best RMSE is used for prediction.
...
or simple visit 
https://aqipredictor10pearls.streamlit.app/
